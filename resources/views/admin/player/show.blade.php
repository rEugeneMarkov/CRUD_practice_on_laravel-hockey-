            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        <h1 class="m-0 mr-2">{{ $player->name }}</h1>
                        <a href="{{ route('admin.player.edit', $player->id) }}" class="text-success"><i
                                class="fas fa-pencil-alt"></i></a>
                        <form action="{{ route('admin.player.delete', $player->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
